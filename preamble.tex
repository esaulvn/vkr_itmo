...
% Убираем курсив из имен авторов (\mkgostheading — внутренняя команда gost-numeric)
...
% Буквы для приложений (исключены е, З, Й, О, Ч, Ъ, Ы, Ь — п. 4.11.2)
...
% Переопределяем \mainmatter: убираем сброс счетчика страниц (п. 4.3.1 — сквозная нумерация)
\makeatletter
